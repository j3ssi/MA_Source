...
class MemReporter():
    ...
    def get_memory_usage(self, verbose=False, target_device=None):
        # header
        printMemory = False
        show_reuse = verbose
    ...
    def report(self, verbose=False, device=None):
        ...
        self.collect_tensor()
        self.get_stats()
        return self.get_memory_usage(verbose, target_device=device)
