...
echo "j: 0 bis 5"
python3 main.py -j 6 --checkpoint ./output/experimente2/prune_LWOLARS_$1 --epochs 5 -s 3 -l 2 -n 5,5,5 --sparse_interval 5 --batchTrue --batchsize 4060 --en_group_lasso --var_group_lasso_coeff 0.2 --threshold 0.1 --lr 0.1 --cifar10 --test --saveModell --test_batch 200 --epochsFromBegin 0 --pathToModell ./output/experimente2/prune_LWOLARS_$1/model.nn 
sleep 20
