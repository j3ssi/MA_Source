...
class ResNet32(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.conv13 = nn.Conv2d(10, 16, kernel_size=3, stride=1, padding=1, bias=False)
		self.bn13 = nn.BatchNorm2d(16)
		self.conv14 = nn.Conv2d(8, 16, kernel_size=1, stride=2, padding=0, bias=False)
		self.bn14 = nn.BatchNorm2d(16)
		self.conv23 = nn.Conv2d(16, 12, kernel_size=3, stride=2, padding=1, bias=False)
		...
		self.conv25 = nn.Conv2d(16, 13, kernel_size=1, stride=2, padding=0, bias=False)
		self.bn25 = nn.BatchNorm2d(13)
		self.conv26 = nn.Conv2d(13, 6, kernel_size=3, stride=1, padding=1, bias=False)
		self.bn26 = nn.BatchNorm2d(6)
		self.conv27 = nn.Conv2d(6, 13, kernel_size=3, stride=1, padding=1, bias=False)
