...
parser.add_argument('--deeper2', default=False, action='store_true',
                    help='Make network deeper')
parser.add_argument('--dSchedule', type=int, nargs='+', default=[93, 150],
                    help='Go deeper at these epochs.')
parser.add_argument('--wSchedule', type=int, nargs='+', default=[93, 150],
                    help='Go wider learning rate at these epochs.')
...
def main():
    ...
    valset = dataloader(root='./dataset/data/torch', train=False, download=True, transform=transform_test)
    ...
    val_loader = torch.utils.data.DataLoader(valset, batch_size=args.batch_size, sampler=valid_sampler,
